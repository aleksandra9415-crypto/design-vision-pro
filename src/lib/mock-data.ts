...
export const plans = [
  {
    ...
    perFrame: "990 ₽ / 30 генераций ≈ 33 ₽ за кадр",
    features: [
      "30 генераций — интерьер, ландшафт и фасад на выбор",
      "Доступные стили — 28",
  ...
  },
  {
    ...
    perFrame: "1490 ₽ / 55 генераций ≈ 27 ₽ за кадр",
    features: [
      "55 генераций — интерьер, ландшафт и фасад на выбор",
      "Доступные стили — 28",
      "Редактор фото",
  ...
  },
  {
    ...
    perFrame: "2990 ₽ / 150 генераций ≈ 20 ₽ за кадр",
    features: [
      "150 генераций — интерьер, ландшафт и фасад на выбор",
      "Доступные стили — 28",
      "Редактор фото",
      "Коммерческая лицензия",
