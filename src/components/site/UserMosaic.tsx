      ...
      {tiles.map((t) => (
        ...
        >
          ...
          <img
            ...
            loading="lazy"
          />
          <figcaption className="absolute inset-x-0 bottom-0 flex items-start justify-between gap-2 bg-background/85 px-3 py-2 text-xs">
            <span className="line-clamp-2 leading-snug">{t.alt}</span>
